...
/**
 * Madgwick algoritmi asennon tunnistamiseen
 */
public class MadgwickAHRS {
    ...
    public float[] GetEulerAngles()
    {
        ...
        result[1] = (float) Math.toDegrees(Math.atan2( quaternion[0]* quaternion[1] +  quaternion[2]* quaternion[3], 0.5f -  quaternion[1]* quaternion[1] -  quaternion[2]* quaternion[2]));
        result[0] = (float) Math.toDegrees(Math.asin(-2.0f * ( quaternion[1]* quaternion[3] -  quaternion[0]* quaternion[2])));
        result[2] = (float) Math.toDegrees(Math.atan2( quaternion[1]* quaternion[2] +  quaternion[0]* quaternion[3], 0.5f -  quaternion[2]* quaternion[2] -  quaternion[3]* quaternion[3]));
